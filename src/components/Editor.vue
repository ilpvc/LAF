    ...
    <div class="r-bottom">
      ...
      <div class="b-nav">
        <div>
          ...
          <Emoji v-show="emoji" :key="emoji"></Emoji>
          <div class="emoji" @click="emojiShow">
            <svg t="1679299088420" class="icon" viewBox="0 0 1024 1024" version="1.1"
                 xmlns="http://www.w3.org/2000/svg"
                 p-id="1406" width="24" height="24">
